...
part '../models/levels_models.dart';
part '../controllers/levels_provider.dart';
part '../controllers/level_detail_controller.dart';
                          ...
                          children: [
                            Text(
                              widget.walletAddress == null
                                  ...
                                  : "Preview ${widget.walletAddress!.substring(0, 6)}...${widget.walletAddress!.substring(widget.walletAddress!.length - 4)} / Easy Games",
...
class EasyGameLevelDetailScreen extends StatefulWidget {
  final int level;
  ...
  @override
  State<EasyGameLevelDetailScreen> createState() =>
      _EasyGameLevelDetailScreenState();
}

class _EasyGameLevelDetailScreenState extends State<EasyGameLevelDetailScreen> {
  final WalletConnectService walletService = Get.find<WalletConnectService>();
  late final String controllerTag;
  late final _LevelDetailController detailController;
  ...
  void initState() {
    super.initState();
    controllerTag = 'level-detail-$level';
  ...
  @override
  void dispose() {
    if (Get.isRegistered<_LevelDetailController>(tag: controllerTag)) {
      Get.delete<_LevelDetailController>(tag: controllerTag);
    }
    super.dispose();
  }
                ...
                if (data != null) ...[
                  ...
                  _LevelStatsStrip(
                    stats: [
                      ...
                      _DetailRow('levelDetail.playerWeight'.tr,
                          data.playerWeight.toString()),
                      _DetailRow('levelDetail.chance'.tr,
                          formatBpsToPercent(data.playerChanceBps)),
                      _DetailRow('levelDetail.boxTokens'.tr,
                          data.player?.boxTokens.toString() ?? '0'),
                      _DetailRow('levelDetail.cycles'.tr,
                          data.state.cycles.toString()),
                      _DetailRow('levelDetail.earned'.tr,
                          '${formatWeiToEth(data.state.earnedWei)} ${walletService.nativeSymbol}'),
                      _DetailRow('levelDetail.position'.tr,
                          data.state.positionId.toString()),
                      _DetailRow('levelDetail.matrixSize'.tr,
                  ...
                  _LevelDetailPanel(
                    ...
                    rows: [
                      _DetailRow('levelDetail.matrixType'.tr,
                          'levelDetail.binaryMatrix'.tr),
                      _DetailRow('levelDetail.rewardModel'.tr,
                          'levelDetail.rewardModelValue'.tr),
                      _DetailRow('levelDetail.totalWeight'.tr,
                          data.advanceStats.totalWeight.toString()),
                      _DetailRow('levelDetail.activeCells'.tr,
                  ...
                  _LevelDetailPanel(
                    ...
                    rows: [
                      _DetailRow('common.active'.tr,
                          data.state.active ? 'common.yes'.tr : 'common.no'.tr),
                      _DetailRow('common.frozen'.tr,
