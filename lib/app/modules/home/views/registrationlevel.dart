...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  late final _RegistrationController registrationController;

  @override
  void initState() {
    super.initState();
    controllerTag = '${widget.level}-${widget.inviter ?? 'default'}';
    registrationController = Get.put(
      _RegistrationController(walletService),
      tag: controllerTag,
    );
    registrationController.configure(
      level: widget.level,
  ...
  @override
  void dispose() {
    if (Get.isRegistered<_RegistrationController>(tag: controllerTag)) {
      Get.delete<_RegistrationController>(tag: controllerTag);
    }
    super.dispose();
  }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _PaymentAssetSelector(
                          ...
                          onChanged: registrationController.selectPaymentAsset,
                        ),
                        const SizedBox(height: 24),
                        Text(
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                onPressed: registrationController.approveUpline,
                          ...
                          children: [
                            Expanded(
                              child: _CheckPill(
                                ...
                                onPressed: registrationController.checkNetwork,
                              ),
                            ),
                            const SizedBox(width: 8),
                            Expanded(
                              child: _CheckPill(
                                ...
                                onPressed: registrationController.checkBalance,
                              ),
                            ),
                          ],
                        ),
