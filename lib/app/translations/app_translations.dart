...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        'es': {...englishTranslations, ...spanishTranslations},
        ...
        'ja': {...englishTranslations, ...japaneseTranslations},
        'tr': {...englishTranslations, ...turkishTranslations},
        'ko': {...englishTranslations, ...koreanTranslations},
